...
/**
 * $specodec — marks a model, enum, or union for specodec code generation.
 * Loaded by TypeSpec via lib/main.tsp only.
 */
export declare function $specodec(context: DecoratorContext, target: Model | Enum | Union): void;

...
export { isCodecType };
import { type Program, type Namespace, type Interface, type Model, type Type } from "@typespec/compiler";
...
export declare function isUnionType(type: Type): boolean;
export declare function isScalarVariant(type: Type): boolean;
export declare function arrayElementType(type: Type): Type | undefined;
export declare function recordElementType(type: Type): Type | undefined;
/**
 ...
 */
export declare function safeFieldName(lang: LangName, name: string): string;
/**
 * Dotted namespace path → snake_case file stub
 * e.g. "MyNS.a.b" → "my_ns_a_b", "AllTypes" → "all_types"
 */
export declare function dottedPathToSnakeCase(path: string): string;
/**
 * Dotted namespace path → PascalCase stub
 * e.g. "my_ns.a.b" → "MyNsAB"
 */
export declare function dottedPathToPascalCase(path: string): string;
...
export declare function formatReservedError(fieldName: string, _modelName: string, reservedIn: LangName[]): string;
/**
 ...
 */
export declare function checkAndReportReservedKeywords(program: Program, services: ServiceInfo[], _ignoreReservedKeywords: boolean): boolean;
